 ...
 */
export function buildVizHtml(dataJson: string, repoName: string, lang: Lang = 'en'): string {
  ...
  return page.replace('__REPO_NAME__', escapeHtml(repoName)).replace('"__HAIDO_DATA__"', safeJson);
}
